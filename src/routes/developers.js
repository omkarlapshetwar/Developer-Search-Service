...
router.get('/developer-profile/:username', async (req, res) => {
  try {
...
router.get('/developer-repos/:username', async (req, res) => {
  try {
...
router.get('/developer-contributions/:username', async (req, res) => {
  try {
...
router.get('/repo-prs/:username/:owner/:repo', async (req, res) => {
  try {
